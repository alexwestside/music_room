...
func middlewareSecure() *secure.Secure {
...
func configuration() {
	serverHTTP.Server.App.Configure(iris.WithConfiguration(iris.Configuration{ // default configuration:
...
func Run() {
	serverHTTP.Server.App.Logger().SetLevel("debug")
